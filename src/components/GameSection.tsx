        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {gameData.games.map((game, index) => (
            <a
              ...
              className="bg-white/90 rounded-2xl shadow-lg hover:shadow-blue-200 overflow-hidden transform hover:scale-105 transition-all border border-[#B3E5FC] group relative"
            >
              ...
              <div className="p-6 flex flex-col items-center">
                <h3 className="text-xl font-bold text-[#02569B] mb-2 text-center">{game.title}</h3>
                <p className="text-gray-700 mb-4 text-center">{game.description}</p>
                <span className="inline-block bg-gradient-to-r from-[#42A5F5] to-[#00C6FB] text-white px-5 py-2 rounded-full font-semibold shadow hover:shadow-blue-200 transition-all duration-300">Play Now</span>
              </div>
            </a>
          ))}
        </div>
