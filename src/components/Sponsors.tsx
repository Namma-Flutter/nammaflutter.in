  ...
  return (
    <section className="py-16 mb-96 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none select-none">
        <Image  width={800} height={800} src="/flutter-pattern.svg" className="w-full h-full object-cover" alt="Flutter pattern background" />
      </div>
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center mb-8">
          <Image  width={800} height={800} src="/flutter-logo.svg" alt="Flutter Logo" className="w-12 h-12 mb-2" />
